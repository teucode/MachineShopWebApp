...
<html>
<head>
	<title>Tampil Spareparts ASC</title>
	<link rel="stylesheet" href="Bootstrap/css/bootstrap.css">
</head>
<body>
	<div class="container">
		<h1>Spareparts Stok ASC</h1>
		<form method="get" action="tampilsparebystokdesc.php" id="form1">       
			<button type="submit" class="btn btn-warning" form="form1" value="DSC" >Ubah menjadi DESC</button>
		</form><br>
		...
		<table class="table table-bordered">
			...
			<?php 
				...
				$data = mysqli_query($conn, "SELECT * from spareparts order by jumlah_stok asc") or die( mysqli_error($conn));				
				$no = 1;
